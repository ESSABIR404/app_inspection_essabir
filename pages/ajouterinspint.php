...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['tag']) || empty($_POST['tag'])) {
        ...
        // Préparation de la requête SQL pour `inspections_interne`
        $req1 = $bdd->prepare('INSERT INTO inspections_interne (tag, insp, methode_insp, etat, commentaire) 
        ...
        if ($insertion1) {
            ...
            $req2 = $bdd->prepare('INSERT INTO rapports (tag, insp, methode_insp, etat, categorie, id_insp_ie) 
                                   VALUES (:tag, :insp, :methode_insp, :etat, "interne", :id_insp_ie)');
            ...
            if ($insertion2) {
                ...
                header("Location: ../pages/inspection-interne.php");
            ...
            $erreur = "Erreur : l'insertion dans la table inspections_interne a échoué !";
        }
    }
}
?>
