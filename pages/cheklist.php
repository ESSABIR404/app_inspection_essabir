...
<body>
 ...
 HTML;
    ...
    <h1 class="p-relative">Checklist d'inspection</h1>
    <?php 
        if ($type_utilisateur === 'inspecteur' && $role === 'admin'){
            echo '<a class="btn btn-primary btn-sm" href="ajoutercheck.php" style="background-color:blueviolet; color: white;">Nouveau checklist</a>';
        }
    ?>
    <div class="container my-5">
        <input type="text" id="searchInput" onkeyup="searchTag()" placeholder="Rechercher par tag..." style="margin: 4px;">
        <table class="table">
            <thead>
                <tr>
                    <th><strong style="color: rgb(54, 19, 120);">Id</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">Tag</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">Inspection</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">Nom d'inspecteur</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">Date de l'inspection</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">Résultat final</strong></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                <?php 
                    ...
                    while ($row = $rsl->fetch(PDO::FETCH_ASSOC)) {
                        echo '<tr>
                                ...
                                <td>' . $row['insp'] . '</td>
                                <td>' . $row['nom_insp'] . '</td>
                                <td>' . $row['date_inspection'] . '</td>
                                <td>' . $row['resultat_final'] . '</td>
                                ';
                            if ($type_utilisateur === 'inspecteur' && $role === 'admin') {
                                echo '<td>
                                <a class="btn btn-primary btn-sm" href="editchecklist.php?idcheck=' . $row['id'] . '" role="button" style="background-color:blueviolet; color: white;">Modifier</a>
                                    <a class="btn btn-primary btn-sm" href="detailchecklist.php?idcheck=' . $row['id'] . '" role="button" style="background-color:blueviolet; color: white;"><i class="bi bi-floppy"></i> Télécharger</a>
                                    <a class="btn btn-danger btn-sm" href="javascript:void(0)" onclick="openModal(' . $row['id'] .')">Supprimer</a>
                                      </td>';
                            }
   ...
   function openModal(id) {
    ...
    swal({
        ...
        if (value) {
            ...
            window.location.href = 'suppchecklist.php?idcheck=' + id;
        } else {
