...
.modal {
        ...
        height: 100%;
        overflow: auto;
        background-color: rgba(0, 0, 0, 0.4); /* Fond semi-transparent pour l'arrière-plan */
    }
    ...
    .modal-content {
        ...
        padding: 20px;
        border-radius: 10px;
        box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); /* Ombre pour effet de profondeur */
        width: 80%;
        max-width: 400px;
    }
    ...
    #confirmDelete {
        background-color: #dc3545; /* Couleur de fond pour le bouton de confirmation */
        color: white;
        border: none;
    }

    #cancelDelete {
        background-color: #6c757d; /* Couleur de fond pour le bouton d'annulation */
        color: white;
        border: none;
    }
    .button-modal{
...
<body>
 ...
 HTML;
  ...
  HTML;
    ...
    <h1 class="p-relative">Les inspecteurs</h1>
    <?php 
        if ($type_utilisateur === 'inspecteur' && $role === 'admin'){
            echo '<a class="btn btn-primary btn-sm" href="ajouterinsp.php" style="background-color:blueviolet; color: white;">Nouveau inspecteur</a>';
        }
    ?>
        ...
        <table class="table">
            ...
            <tbody>
                <?php 
                    ...
                    $sql = "SELECT id_inspecteur, nom, prenom, email, telephone, poste_occupe, entreprise, adresseent, departement FROM inspecteurs";
                    $rsl = $conn->query($sql);
                    ...
                    while ($row = $rsl->fetch(PDO::FETCH_ASSOC)) {
                        echo '<tr>
                            ...
                            if ($type_utilisateur === 'inspecteur' && $role === 'admin') {
                                echo '<td>
                                <a class="btn btn-primary btn-sm" href="editinsp.php?id_inspecteur=' . $row['id_inspecteur'] . '" role="button" style="background-color:blueviolet; color: white;">Modifier</a>
                                <a class="btn btn-danger btn-sm" href="javascript:void(0)" onclick="openModal(' . $row['id_inspecteur'] .')">Supprimer</a>
                                      </td>';
                            }
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
   function openModal(id_inspecteur) {
    ...
    swal({
        ...
        if (value) {
            ...
            window.location.href = 'suppinsp.php?id_inspecteur=' + id_inspecteur;
        } else {
