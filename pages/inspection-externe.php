...
<body>
 ...
 HTML;
  ...
  HTML;
    ...
    <h1 class="p-relative">Inspection externe</h1>
    <?php 
        if ($type_utilisateur === 'inspecteur' && $role === 'admin'){
            echo '<a class="btn btn-primary btn-sm" href="ajouterinspext.php" style="background-color:blueviolet; color: white;">Nouveau inspection</a>';
        }
    ?>
        ...
        <table class="table">
            ...
            <tbody>
                <?php 
                    ...
                    $sql = "SELECT * FROM inspections_externe";
                    $rsl = $conn->query($sql);
                    ...
                    while ($row = $rsl->fetch(PDO::FETCH_ASSOC)) {
                        echo '<tr>
                            ...
                            if ($type_utilisateur === 'inspecteur' && $role === 'admin') {
                                echo '<td>
                                <a class="btn btn-primary btn-sm" href="editinspext.php?idinsp=' . $row['id'] . '" role="button" style="background-color:blueviolet; color: white;">Modifier</a>
   ...
   function openModal(id) {
    ...
    swal({
        ...
        if (value) {
            ...
            window.location.href = 'suppinspext.php?idinsp=' + id;
        } else {
