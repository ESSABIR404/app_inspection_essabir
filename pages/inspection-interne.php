...
<body>
 ...
 HTML;
  ...
  HTML;
    ...
    <h1 class="p-relative">Inspection interne</h1>
    <?php 
        if ($type_utilisateur === 'inspecteur' && $role === 'admin'){
            echo '<a class="btn btn-primary btn-sm" href="ajouterinspint.php" style="background-color:blueviolet; color: white;">Nouveau inspection</a>';
        }
    ?>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><strong style="color: rgb(54, 19, 120);">Méthode utilisée</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">État</strong></th>
                    <th><strong style="color: rgb(54, 19, 120);">Commentaire</strong></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                <?php 
                    ...
                    $sql = "SELECT * FROM inspections_interne";
                    $rsl = $conn->query($sql);
                    ...
                    while ($row = $rsl->fetch(PDO::FETCH_ASSOC)) {
                        echo '<tr>
                                ...
                                <td>' . $row['tag'] . '</td>
                                <td>' . $row['insp'] . '</td>
                                <td>' . $row['methode_insp'] . '</td>
                                <td>' . $row['etat'] . '</td>
                                <td>' . $row['commentaire'] . '</td>
                                ';
                            if ($type_utilisateur === 'inspecteur' && $role === 'admin') {
                                echo '<td>
                                <a class="btn btn-primary btn-sm" href="editinspint.php?idinsp=' . $row['id'] . '" role="button" style="background-color:blueviolet; color: white;">Modifier</a>
   ...
   function openModal(id) {
    ...
    swal({
        ...
        if (value) {
            ...
            window.location.href = 'suppinspint.php?idinsp=' + id;
        } else {
